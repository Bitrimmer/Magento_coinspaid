...
/**
 * Class Coinspaid
 * @package Coinspaid\Coinspaid\Model
 */
class Coinspaid extends AbstractMethod
{
	/**
	 * @var bool
	 */
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Coinspaid\Coinspaid\Block\Form\Coinspaid';
	...
	/**
	 * Вызывается при запросе Pay URL со стороны Coinspaid
	 *
	 * @param $responseData
	 */
	 ...
	 * @return bool
	 */
	protected function _processOrder(Order $order)
	{
			/** @var \Magento\Sales\Model\Order\Payment $payment */
			$payment = $order->getPayment();

			$payment->setTransactionId('123123')->setIsTransactionClosed(0);
